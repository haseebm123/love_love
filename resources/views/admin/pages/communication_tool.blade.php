...
@section('body')
    ...
    <div class="row">
        <div class="col-3">
            <h1>Disappear Message</h1>
            <h6>Disappear Message</h6>
            ...
            <div class="card mt-2 background-card sidebar-content card">
                <div class="card-content">
                    <div class="card-body " style="position: relative;">
                        ...
                        <div class="scroller">
                            @include('admin.pages.users_management.ajax.user_disappear_massage')
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-content collapse show">
                                                @include('admin.pages.components.user_detail')
                                            </div>
                                        </div>
                                    </div>
                                </div>
